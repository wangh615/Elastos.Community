...
const zh = {
    ...
    'home.organizers.help_1': '帮助组织聚会并推广亦来云',
    'home.organizers.help_2': '无论您已成为社区的一员还是想要加入，',
    ...
    'developer.cr100.welcome.1': 'Cyber Republic 100（以下简称CR100）是亦来云的旗舰项目，邀请企业家团队申请资金来设计和建造下一代伟大的亦来云 DApp生态系统，下面列出的是能体现出亦来云基础设施多样性和强大功能的100个模板项目。',
    'developer.cr100.welcome.2': '每个项目代表了DApp能颠覆的传统模型下的应用场景。申请团队可以根据这些应用场景迸发灵感来撰写自己现有的或未来的白皮书，并提交详细的提案，阐述项目计划。',
    'developer.cr100.welcome.3': 'CyberRepublic共治委员会将选择特别有前景的项目，并为选定的团队提供10万美金作为最初的启动资金。需要注意的是：虽然CR100旨在创造生态多样性，但是我们也可能在每个类别下资助不只一个DApp。此外，如果您没有发现适合您项目的类别，可以提交新的类别。详情请见本页底部。',
    ...
    'developer.form.submission.type.option.other': '其它',
    ...
    'training.header.content.2': '支付所有行程花费，在不同地区接受亦来云团队',
    ...
    'training.thanksForApplying': '感谢您的申请，我们将尽快与您取得联系！',
    ...
    'landing.runtime.content.2': '可以运行在移动设备或个人电脑上',
    'landing.runtime.content.3': '并防止应用程序直接访问互联网。',
    'landing.runtime.content.4': '',
    'landing.software': '亦来云',
    'landing.software.devkit': 'SDK',
    'landing.software.content.1': '用于访问IDs和亦来云',
    'landing.software.content.2': '智能网络上的Carrier服务。',
    ...
    'landing.application.content.1': '亦来云上的应用程序将运行在利用区块链技术构建的可靠运行环境中。它通过提供一个“沙箱”环境来创建真正的安全性，在允许访问互联网之前，该环境需要从区块链得到验证。这为构建任何类型的应用程序和任何用例或场景提供了巨大的潜力。',
    ...
    'landing.0230': '亦来云上的应用程序将运行在区块链技术构建的可靠运行环境中。它通过提供一个“沙箱”环境来创建真正的安全性：在允许访问互联网之前，该环境需要获得区块链上的验证。这为构建各种用例或场景的任何应用程序提供了巨大的潜力。',
    'landing.0231': '',
    ...
    'vision.04': '与此同时，我们已经组建了一个Cyber Republic过渡委员会来决定在这个项目朝着完全民主去中心化的方向发展。目前这个委员会由李斐, 张戈, 和苏翼鹏组成，他们将利用来自社区的贡献，做出战略决定来不断壮大这个项目。随着时间的推移, Empower35项目的成员和Cyber Republic其他领导者将会组建成为一个社区自治“政府”。 我们的社区章程正在编制更新中。',
    ...
    'from.CVoteForm.label.motion.help': '如果这是针对现有的议案作出的动议，请指明现有的议案编号',
    ...
    'from.OrganizerAppForm.language': '您的母语是什么，谁是您的听众和他们所在的地区位于哪里?您会使用哪（几）种语言去介绍亦来云。',
    ...
    'from.SubmissionCreateForm.description.required': '您必须提供描述',
    ...
    'from.Training1Form.text.nativelanguage': '您的母语是什么，谁是您的听众和他们所在的地区位于哪里?您会使用哪（几）种语言去介绍亦来云。',
    ...
    'cr-video.q1.paragraph.1': '现在的互联网架构促使权力与知识越来越集中于某几个跨国企业而难以规范，它们容易发生腐败，会对用户进行审查并滥用权力',
